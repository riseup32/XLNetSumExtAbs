...
def abs_loss(generator, decoder, symbols, vocab_size, device, train=True, label_smoothing=0.0):
    compute = NMTLossCompute(
        generator, decoder, symbols, vocab_size,
...
class LossComputeBase(nn.Module):
    ...
    def __init__(self, generator, decoder, pad_id):
...
class NMTLossCompute(LossComputeBase):
    ...
    def __init__(self, generator, decoder, symbols, vocab_size,
                 label_smoothing=0.0):
        super(NMTLossCompute, self).__init__(generator, decoder, symbols['PAD'])
    ...
    def _compute_loss(self, batch, output, target):
        ...
        # attn_loss = self.decoder.sum_attn_std
        # print('attn_loss:', attn_loss)

        # retain_graph  or  Variable(requires_grad=True)
