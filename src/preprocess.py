...
def do_format_to_xlnet(args):
    print(time.clock())
    data_builder.format_to_xlnet(args)
    print(time.clock())
...
if __name__ == '__main__':
    ...
    parser.add_argument("-pretrained_model", default='xlnet', type=str)
    ...
    parser.add_argument("-use_xlnet_basic_tokenizer", type=str2bool, nargs='?',const=True,default=False)
